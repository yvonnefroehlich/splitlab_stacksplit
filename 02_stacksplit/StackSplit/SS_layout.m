function h = SS_layout( ...
    push1_callback, push2_callback, push3_callback, push4_callback, ...
    list_callback,...
    check1_callback, check2_callback, check3_callback, check4_callback, ...
    pop1_callback, push5_callback, pop2_callback, pop3_callback, ...
    pop4_callback, pop5_callback ...
)
%==========================================================================
%##########################################################################
%#                                                                        #
...
set(h.ev_info,'String','                  t0time           JD      BAZ     dist     inipol     inc    SNR         filter        phase')
...
%==================================================================================================================================
%==================================================================================================================================
% Panel << Selection window >> pop up wdw for SIMW taper selection
...
%==================================================================================================================================
%==================================================================================================================================
% Panel << Selection window >> pop up wdw for selection between Emap and EVmap (lambda2map)
...
%==================================================================================================================================
%==================================================================================================================================
% Panel << Selection window, Limits >> pop up wdw for max BAZ, max dist and max pol
